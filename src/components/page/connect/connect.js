      ...
      <section className="connect-section">
        ...
        >
          <ul>
            ...
            <li>
              {" "}
              <a href="https://www.linkedin.com/in/madhava-y/" target="_blank" rel="noopener noreferrer">
                LinkedIn
              </a>
            </li>
            <li>
              {" "}
              <a href="mailto:madhavayedla@gmail.com" target="_blank" rel="noopener noreferrer">
                Email
              </a>{" "}
            </li>
            <li>
